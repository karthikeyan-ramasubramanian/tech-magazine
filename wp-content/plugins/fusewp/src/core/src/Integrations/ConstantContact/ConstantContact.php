...
class ConstantContact extends AbstractIntegration
{
    ...
    public function get_email_list()
    {
        try {
            ...
            return $this->apiClass()->getContactList();
    ...
    public function apiClass($config_access_token = '')
    {
        ...
        if ($instance->hasAccessTokenExpired()) {
            ...
            if ($result) {
                ...
                $old_data['constantcontact']['access_token'] = $result['data']['access_token'];
                $old_data['constantcontact']['expires_at']   = $result['data']['expires_at'];
