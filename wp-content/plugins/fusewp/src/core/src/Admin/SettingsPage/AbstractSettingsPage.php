...
abstract class AbstractSettingsPage
{
    ...
    public static function sidebar_support_docs()
    {
        ...
        $content .= sprintf(
            ...
            '<a class="fusewp-link" href="' . $support_url . '" target="_blank">', $link_icon . '</a>'
        );
        ...
        $content .= sprintf(
            ...
            '<a class="fusewp-link" href="https://fusewp.com/docs/" target="_blank">', $link_icon . '</a>'
        );
        ...
        $content .= sprintf(
            ...
            '<a class="fusewp-link" href="https://wordpress.org/support/plugin/fusewp/reviews/?filter=5#new-post" target="_blank">', $link_icon . '</a>'
        );
        $content .= '</p>';
