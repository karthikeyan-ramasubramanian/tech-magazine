...
{
    return apply_filters_deprecated( 'molongui_authorship_dont_render_author_box', array( $value, $post ), '4.4.0', 'authorship/box/hide' );
}
add_filter( 'authorship/box/hide', 'authorship_deprecated_filter_dont_render_box', 0, 2 );