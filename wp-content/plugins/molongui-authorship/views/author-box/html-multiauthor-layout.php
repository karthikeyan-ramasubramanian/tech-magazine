...
<div id="mab-<?php echo $random_id; ?>"
    ...
    <div class="m-a-box-container
        ...
        <?php if ( $settings['layout'] != 'slim' and !empty($settings['show_related']) and $settings['show_related'] == 1 ) : ?>
                ...
                <div class="m-a-box-content-middle">
                    ...
                    <div class="m-a-box-item m-a-box-related-entries" <?php echo ( $settings['layout'] == 'slim' ? 'style="display: none;"' : '' ); ?>>
                        ...
                        <ul class="molongui-font-size-<?php echo $settings['related_text_size']; ?>-px <?php echo $related_text_style; ?>">
					        ...
					        {
						        echo ' <span class="m-a-box-string-no-related-posts">'. ( $settings[ 'no_related_posts' ] ? $settings[ 'no_related_posts' ] : __( "These authors do not have any more posts in common.", 'molongui-authorship' ) ).'</span>';
					        }
					        ?>
                        </ul>
