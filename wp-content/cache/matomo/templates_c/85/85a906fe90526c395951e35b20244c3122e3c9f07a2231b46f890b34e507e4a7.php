...
class __TwigTemplate_8729a3378f7c35cbfdfbb2ba5ebadc579e072301294feeed78c9a73f68bbb0d3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            // line 15
            if ((twig_get_attribute($this->env, $this->source, (isset($context["visitInfo"]) || array_key_exists("visitInfo", $context) ? $context["visitInfo"] : (function () { throw new RuntimeError('Variable "visitInfo" does not exist.', 15, $this->source); })()), "getColumn", [0 => "location"], "method", false, false, false, 15) != call_user_func_array($this->env->getFilter('translate')->getCallable(), ["General_Unknown"]))) {
...
{% endif %}
", "@Live/_visitorDetails.twig", "/home/blogs.techsnapie.com/public_html/wp-content/plugins/matomo/app/plugins/Live/templates/_visitorDetails.twig");
    }
}
